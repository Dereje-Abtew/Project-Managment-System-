...
const DropdownMenu = ({
  ...
  const [isEditIssueModalOpen, setEditIssueModal] = useState(false);
  ...
  return (
    <>
            ...
            <div className="w-40 bg-white rounded-md border shadow select-none p-1 divide-y">
              ...
              <div className="py-[3px]">
                <Popconfirm
                  ...
                  onConfirm={(e) => handleDelete(e, issueId)}
                >
      ...
      <AddIssueModal
        isAddIssueModalOpen={isEditIssueModalOpen}
        setAddIssueModal={setEditIssueModal}
        risks={risks}
        issueId={issueId}
        issue={issue}
        tasks={tasks}
